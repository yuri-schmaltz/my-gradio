...
readme_template = Path(README_TEMPLATE_FILEPATH).read_text(encoding="utf-8")
getting_started_template = Path(GETTING_STARTED_TEMPLATE_FILEPATH).read_text(encoding="utf-8")
